"""lake_area_club_22498 URL Configuration
...
admin.site.site_header = "Lake Area Club"
admin.site.site_title = "Lake Area Club Admin Portal"
admin.site.index_title = "Lake Area Club Admin"

# swagger
api_info = openapi.Info(
    title="Lake Area Club API",
    default_version="v1",
    description="API documentation for Lake Area Club App",
)
